...
@Tag(name = "Accounts", description = "Accounts REST APIs For Microservice Accounts")
@RestController
...
public class AccountsController {
    ...
    public ResponseEntity<List<CustomerDto>> fetchAllAccounts() {
        List<CustomerDto> customerDtos = accountService.fetchAllAccounts();
    ...
    @PutMapping("/update")
    public ResponseEntity<CustomerDto> updateAccount(@Valid @RequestBody CustomerDto dto) {
        CustomerDto customerDto = accountService.updateAccount(dto);
        return ResponseEntity
                .status(HttpStatus.OK)
                .header("message", "Account updated successfully")
                .body(customerDto);
    }
    ...
    public ResponseEntity<ResponseDto> deleteAccount(@RequestParam
        ...
        if (accountService.deleteAccount(mobileNumber)) {
            ...
            throw new ResourceNotFoundException("Customer", "Customer", "Customer with Account not found");
        }
